...
export interface ApiAttractionAttraction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    highlights: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    ...
    monuments: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiMonumentMonument extends Struct.CollectionTypeSchema {
...
export interface ApiTestWithImageTestWithImage
  extends Struct.CollectionTypeSchema {
  collectionName: 'test_with_images';
  info: {
    displayName: 'Test with images';
    pluralName: 'test-with-images';
    singularName: 'test-with-image';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::test-with-image.test-with-image'
    >;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::test-with-image.test-with-image': ApiTestWithImageTestWithImage;
